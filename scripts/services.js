...
let figure = servicesGrid.querySelector('figure');
...
function changeServicesContent(tag) {
	...
	switch (tag) {
		...
		case 'identity-en':
			img.src = '../assets/services/identity.svg';
			h2 = 'Have a unique, striking, and innovative visual identity';
			p = "It's through visual identity that a brand's values and purposes are conveyed, making it essential for any business aiming for success.";
			break;
		case 'card-en':
			img.src = '../assets/services/card.svg';
